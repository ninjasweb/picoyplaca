...
export async function GET(NextRequest) {
  ...
  if (!city) {
    ...
    return NextResponse.json(cityRestrictions, {
      status: 200,
    });
  }
  ...
  // Obtiene el nombre de la ciudad con la primera letra en mayúscula (ejemplo: "Ibagué")
  const cityName = selectedCity.name;

  // Busca las restricciones de la ciudad en el objeto cityRestrictions
  const cityRestriction = cityRestrictions[cityName];
